...
locator = {
    ...
    # New locators
    "forget_your_password_link": (By.XPATH, '//*[@id="login_form"]/div/p[1]/a'),
    "retrieve_password_link": (By.XPATH, '//*[@id="form_forgotpassword"]/fieldset/p/button'),
    "rec_email": (By.XPATH, 'rec_email'),
    "succ_retrieve_password": (By.XPATH, '//*[@id="center_column"]/div/p'),
    "unsucc_retrieve_password_msg": (By.XPATH, '//*[@id="center_column"]/div/div/ol/li/text()')
}
